...
function AuthProvider(_a) {
    ...
    var checkAuth = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    session = _b.sent();
                    return [4 /*yield*/, session.json()];
                case 2:
                    data = _b.sent();
                    setUser((_a = data === null || data === void 0 ? void 0 : data.user) !== null && _a !== void 0 ? _a : null);
                    return [3 /*break*/, 5];
                case 3:
                    error_1 = _b.sent();
                    setUser(null);
    ...
    var logout = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, react_2.signOut({ redirect: false })];
                case 1:
                    _a.sent();
                    setUser(null);
                    router.push('/login');
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, login(userData.email, userData.password)];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
    ...
    return (React.createElement(AuthContext.Provider, { value: { user: user, loading: loading, login: login, logout: logout, register: register } }, children));
}
